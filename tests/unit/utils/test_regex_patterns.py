...
class TestSerialIdExtraction:
    ...
    @pytest.mark.parametrize(
        ...
        [
            # === 基本格式测试 - 应该匹配 ===
            ("ABC-123.mp4", SerialId(prefix="ABC", number="123")),  # 连字符分隔
...
class TestAdvancedEdgeCases:
    ...
    def test_complex_filename_scenarios(self):
        ...
        test_cases = [
            # === 应该匹配的情况 ===
            ("[2023]ABC-123[1080p][HD].mp4", SerialId(prefix="ABC", number="123")),
            ("(Uncensored)ABC-123(Leaked).mp4", SerialId(prefix="ABC", number="123")),
            ("ABC-123_v2_Final.mp4", SerialId(prefix="ABC", number="123")),
            ("ABC-123-Repack.mp4", SerialId(prefix="ABC", number="123")),
            ("ABC-123_Extended_Cut.mp4", SerialId(prefix="ABC", number="123")),
            ("ABC123[1080p][HD].mp4", SerialId(prefix="ABC", number="123")),  # 无分隔符
            ("ABC123_v2_Final.mp4", SerialId(prefix="ABC", number="123")),  # 无分隔符
            # === 不应该匹配的情况 ===
    ...
    def test_length_boundary_validation(self):
        ...
        letter_length_tests = [
            ...
            # === 应该匹配的情况 ===
            ("AB-12.mp4", SerialId(prefix="AB", number="12")),  # 2个字母（最小）
    ...
    def test_context_boundary_validation(self):
        ...
        boundary_tests = [
            # === 应该匹配的情况 ===
            ("ABC-123.mp4", SerialId(prefix="ABC", number="123")),  # 正常情况
            ("1ABC-123.mp4", SerialId(prefix="ABC", number="123")),  # 前面是数字
...
class TestEdgeCasesAndSpecialScenarios:
    ...
    def test_file_extension_variations(self):
        ...
        extension_tests = [
            # === 应该匹配的情况 ===
            ("ABC-123.mp4", SerialId(prefix="ABC", number="123")),  # 视频文件
            ("ABC-123.avi", SerialId(prefix="ABC", number="123")),  # 视频文件
            ("ABC-123.mkv", SerialId(prefix="ABC", number="123")),  # 视频文件
            ("ABC-123.jpg", SerialId(prefix="ABC", number="123")),  # 图片文件
            ("ABC-123.png", SerialId(prefix="ABC", number="123")),  # 图片文件
            ("ABC-123.txt", SerialId(prefix="ABC", number="123")),  # 文本文件
            ("ABC-123.zip", SerialId(prefix="ABC", number="123")),  # 压缩文件
            ("ABC-123", SerialId(prefix="ABC", number="123")),  # 无扩展名
            # === 不应该匹配的情况 ===
            ("ABC.mp4", None),  # 缺少数字
            ("123.mp4", None),  # 缺少字母
        ]
    ...
    def test_special_characters_and_unicode(self):
        ...
        special_char_tests = [
            # === 应该匹配的情况 ===
            ("ABC-123[1080p].mp4", SerialId(prefix="ABC", number="123")),  # 方括号
            ("ABC-123(HD).mp4", SerialId(prefix="ABC", number="123")),  # 圆括号
            ("ABC-123_uncensored.mp4", SerialId(prefix="ABC", number="123")),  # 下划线
            ("ABC-123-Repack.mp4", SerialId(prefix="ABC", number="123")),  # 连字符
            ("ABC-123.2023.mp4", SerialId(prefix="ABC", number="123")),  # 点号
            ("ABC-123@special.mp4", SerialId(prefix="ABC", number="123")),  # @符号
            ("ABC-123#tag.mp4", SerialId(prefix="ABC", number="123")),  # #符号
            # === 不应该匹配的情况 ===
    ...
    def test_case_insensitive_matching(self):
        ...
        case_tests = [
            # === 应该匹配的情况 ===
            ("abc-123.mp4", SerialId(prefix="ABC", number="123")),  # 全小写
